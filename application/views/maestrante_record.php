...
echo form_input('idpersona',$options[$maestrante['idpersona']],array("disabled"=>"disabled")) ?></td>
  </tr>
...
echo form_input('idmaestrante_estado',$options[$maestrante['idmaestrante_estado']],array("disabled"=>"disabled")) ?></td>
  </tr>
...
echo form_input('idmaestria',$options[$maestrante['idmaestria']],array("disabled"=>"disabled")) ?></td>
  </tr>
