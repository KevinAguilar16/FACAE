...
function evento_data()
{
		...
		$draw= intval($this->input->get("length"));
	 	...
	 	$data0 = $this->evento_model->lista_eventos();
		$data=array();
		foreach($data0->result() as $r){
			$data[]=array($r->idevento,$r->fechaelaboracion,$r->fechaentrerecep,$r->asunto,$r->archivopdf,
				$r->href='<a href="javascript:void(0);" class="btn btn-info btn-sm item_pdf"  data-idevento="'.$r->idevento.'" data-archivopdf="'.base_url()."pdfs/".$r->archivopdf.'">pdf</a>');
		}	
